  ...
  return (
    <div className='flex w-full h-[85vh] responsiveh'>
        <div className='w-2/4 flex flex-col justify-center items-start'>
            <small className='text-xl font-normal leading-8'>Hi, my name is Kristina.</small>
            <h1 className='text-8xl uppercase font-bold my-2'>I design for growth.</h1>
            <p className='text-xl font-normal leading-8'>I’m a Senior Growth Product Designer with a marketing background, Growth Design Mentor at GDS and Career Coach at Liftyz.</p>
